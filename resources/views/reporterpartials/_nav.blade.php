<header class="main-header">
    <!-- Logo -->
    <a href="{{ route('journalist.dashboard') }}" class="logo">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-success">{{ $coms->count() }}</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">You have {{ $coms->count() }} messages</li>
              <li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('admin/dist/img/'.Auth::user()->image) }}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  {{ Auth::user()->name }} - {{ ucfirst(Auth::user()->job_title) }}
