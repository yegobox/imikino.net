      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <form id="upload-formm" enctype="multipart/form-data">
                  <div class="row">
                ...
                <form id="upload-form22" enctype="multipart/form-data">
                  <div class="row">
                      <div class="form-group col-md-6">
                          {{--  {{ Form::label('image1', 'Add Featured Image 1:') }}  --}}
                ...
                <form id="upload-form33" enctype="multipart/form-data">
                  <div class="row">
                      <div class="form-group col-md-6">
                          {{--  {{ Form::label('image1', 'Add Featured Image 1:') }}  --}}
                ...
                <form id="upload-form44" enctype="multipart/form-data">
                  <div class="row">
                      <div class="form-group col-md-6">
                          {{--  {{ Form::label('image1', 'Add Featured Image 1:') }}  --}}
                ...
                <form id="upload-form55" enctype="multipart/form-data">
                  <div class="row">
                      <div class="form-group col-md-6">
                          {{--  {{ Form::label('image1', 'Add Featured Image 1:') }}  --}}
        ...
        <div class="col-md-4">
            <div class="well">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {!! Html::linkRoute('livestream.edit', 'Edit', array($post->id ),array('class' => 'btn btn-primary btn-block')) !!}
                    </div>

                    <div class="col-sm-6">
                        {!! Form::open(['route' =>['livestream.destroy', $post->id], 'method' => 'DELETE']) !!}
