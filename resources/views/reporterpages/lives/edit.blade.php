  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        {!! Form::model($post, ['route' => ['livestream.update', $post->id], 'method' => 'PUT', 'files' => true]) !!}
        <div class="col-md-8">
        ...
        <div class="col-md-4">
            <div class="well">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        {!! Html::linkRoute('livestream.show', 'Cancel', array($post->id ),array('class' => 'btn btn-danger btn-block')) !!}
                    </div>
